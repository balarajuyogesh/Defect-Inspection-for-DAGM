...
def Conv12k4(input_size, label_size, **kwargs):
    ...
    """
    model = ConvNetJK(OneConvBlock, [2, 3, 4], k=4, input_size=input_size,
                      num_classes=label_size, **kwargs)    
    return model

def Conv12k8(input_size, label_size, **kwargs):
    """Constructs a ResNet-18 model.
        
    Args:
       
    """
    model = ConvNetJK(OneConvBlock, [2, 3, 4], k=8, input_size=input_size,
                      num_classes=label_size, **kwargs)    
    return model